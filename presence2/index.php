                ...
                <div data-aos="fade-right" class="about-child">
                    <div class="about-child-img">
                        <div class="img-background">
                            <img src="assets/images/about/me5.png" alt="my profile image">
                        </div>
                    </div> 
                </div>
                ...
                <div class="projects-container">
                    <?php
						...
						if ($result -> num_rows > 0) {
							...
							echo '<a href=" '.$url. '" target="_blank" class="project" data-aos="fade-left">
                        			<img src="assets/images/portfolio/' .$img. '" alt="project image">
                        			<div class="project-details">
                            			<div class="project-title">' .$title. '</div>
                            			<p>' .$desc. '<span>View <i class="fa fa-arrow-right"></i></span></p>
                        			</div>
                    			</a>';
							}
						}else {
							echo '<p>NO PROJECT TO SHOWCASE';
						}
					?>
                    <a href="" class="project" data-aos="fade-left">
                        <img src="assets/images/app-images/vq-hero2.PNG" alt="project image">
                        <div class="project-details">
                    ...
                    <a href="" class="project" data-aos="fade-left">
                        <img src="assets/images/app-images/Screenshot 2025-10-03 171910.jpg" alt="project image">
                        <div class="project-details">
                    ...
                    <div class="contact-content">
                        <div class="contact-content-child">
                            ...
                            <div class="social-links" data-aos="fade-right">
                                ...
                                <ul>
                                    <li><a href="https://github.com/cachecoder01" target="_blank"><i class="fab fa-github"></i></a></li>
                                    <li><a href="https://www.tiktok.com/@_pyper_02?_t=ZS-90eZnq5oNe4&_r=1" target="_blank"><i class="fab fa-tiktok"></i></a></li>
                                    <li><a href="https://www.linkedin.com/in/cachecoder02" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                        ...
                        <div class="contact-content-child">
                            <form data-aos="fade-left" action="https://api.web3forms.com/submit" method="POST">
                                ...
                                <input type="hidden" name="redirect" value="http://localhost/presence/presence2/thanks.html">
                    ...
                    <footer>
                        <div class="copyrights">
                            <div class="copyrights-child">
                                <p>copyrights <span id="footerDate"></span> | <span class="me">Designed and Developed by <a href="https://cachecoder.site" target="_blank">CacheCoder</a></span></p>
                            </div>
                            <div class="copyrights-child">
